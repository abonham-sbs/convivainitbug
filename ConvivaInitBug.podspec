#
# Be sure to run `pod lib lint ConvivaInitBug.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  s.name             = 'ConvivaInitBug'
  s.version          = '0.1.0'
  s.summary          = 'A short description of ConvivaInitBug.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/Aaron Bonham/ConvivaInitBug'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'Aaron Bonham' => 'aaron.bonham@sbs.com.au' }
  s.source           = { :git => 'https://github.com/Aaron Bonham/ConvivaInitBug.git', :tag => s.version.to_s }
